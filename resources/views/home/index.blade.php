                    ...
                    <div class="row p-2">
                        ...
                        <div class="col button d-flex">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#modalItem{{ $contador }}" style="height: 45px;
                                width: 140px;
                                margin-right: 2px;">
                                Adicionar item
                            </button>
                        ...
                        <div class="col d-flex flex-row justify-content-center">
                            <form class="me-2" action="{{ route('account-destroy', ['id' => $acount->id]) }}"
                                method="post">
                                @csrf
                                @method('delete')
                            ...
                            <a href="{{ route('account-edit', ['id' => $acount->id]) }}" class="btn btn-primary" style="height: 45px;">
