            ...
            <tbody>
                @foreach ($listaCategorias as $categoria)
                    <tr class="text-light">
                        ...
                        <td>{{ $categoria->name_user }}</td>
                        <td>{{ App\Http\Controllers\productsController::formatDate($categoria->created_at) }}</td>
                        <td class="d-flex">
                            <a href="{{ route('categoria-edit', ['id' => $categoria->id]) }}" class="btn btn-primary me-2">
